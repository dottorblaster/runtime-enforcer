...
|*Minimum Kernel*
|5.8
|Limitation: max binary path length in policies is 512 characters.

|*Recommended Kernel*
|5.11+
|No limitations in binary path lengths
...
|*Red Hat Enterprise Linux 8.x (untested)*
|4.18†
|4.18†
|✓
|✓
...
|*Red Hat Enterprise Linux 9.x (untested)*
|5.14
|5.14+
|✓
|✓
